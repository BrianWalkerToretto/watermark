    ...
    (o.m = r = {
            ...
            return (
              ...
              n.noRender
                ...
                : ((n.canvas = a.a.createRef()),
                  ...
                  (n.draw = window.ActiveXObject ? h.c : h.b),
                  n.initWaterMark(),
                  n.loadWaterMark(),
                  n)
            );
            ...
            return function(t, n, e, r) {
              for (
                var o,
                  ...
                  s = 0,
                  l = r || j,
                  p = h ? l(t, f) : v ? l(t, 0) : undefined;
                s < f;
                s++
              )
                if ((w || s in c) && ((i = a((o = c[s]), s, u)), d))
                  if (h) p[s] = i;
                  else if (i)
                    switch (d) {
                      case 3:
          ...
          n.exports =
            ...
            t(function() {
              ...
              return (
                ...
                7 != i({}, t)[e] || d(i({}, n)).join('') != r
              );
            })
              ? function(t, n) {
                  for (
                    var e = g(t), r = arguments.length, o = 1, i = h.f, u = v.f;
                    o < r;
      ...
      BsL6: function(t, n, e) {
        ...
        var r = e('eLKs'),
          ...
          p = {
            ...
            props: {
              text: { type: [String, Number, Array, Object], required: !0 }
            },
            beforeCreate: function() {
              (this.ie = !!window.ActiveXObject || 'ActiveXObject' in window),
                (this.draw = window.ActiveXObject ? s.c : s.b);
            },
            created: function() {
              if (
                ((this.data = Object(a.a)({ text: this.text })),
                (this.noRender = !this.data.text),
                this.noRender)
              )
                return !(this.mounted = function() {});
              this.initWaterMark(), this.loadWaterMark();
            },
            mounted: function() {
              var t = this,
                n = o()(s.a).call(s.a, this);
              Object(l.b)(
                'resize',
                Object(i.a)(function() {
                  n() && t.waterMark();
            ...
            methods: {
              loadWaterMark: u.a,
              initWaterMark: Object(c.a)('waterMark'),
              waterMark: function() {
                if (!this.can) return this.initWaterMark(), !1;
                var t = Object(f.a)(),
                  n = t.width,
          ...
          d = e('S91v');
        var h = (function y(t, n, e, r, o, i, u, c) {
          var a,
        ...
        var v,
          g =
            ((v = h),
            function(t, n) {
              void 0 === n && (n = {}), t.component(v.name, v);
            });
      ...
      'I+eb': function(t, n, e) {
        ...
        t.exports = function(t, n) {
          var e,
            ...
            a = t.global,
            f = t.stat;
          if ((e = a ? s : f ? s[c] || h(c, {}) : (s[c] || {}).prototype))
            for (r in n) {
              if (
                ((i = n[r]),
              ...
              (t.sham || (o && o.sham)) && p(i, 'sham', !0), d(e, r, i, t);
            }
        };
      },
      I1Gw: function(t, n, e) {
      ...
      jP1q: function(t, n, e) {
        ...
        var r = e('eLKs'),
          ...
          d = e.n(p);
        function h(t) {
          if ((void 0 === t && (t = {}), t && 'object' == typeof t))
            return this instanceof h ? this.init(t) : new h(t);
        }
        (h.prototype = {
          constructor: h,
          ...
          init: function(t) {
            if (
              ((this.canvas.className = d.a.waterMark),
              document.body.appendChild(this.canvas),
              (this.data = Object(a.a)(t)),
              (this.noRender = !this.data.text),
              this.noRender)
            )
              return !1;
      ...
      kBWp: function(t, n, e) {
        (n = t.exports = e('JPst')(!1)).push([
          t.i,
          '.watermark__waterMark-2yj37[data-v-0591079e] {\n  position: absolute;\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  z-index: 99;\n  pointer-events: none;\n  /* IE 6/7/8/9/10 */\n  z-index: -99 \\8\\9\\0;\n  /* stylelint-disable-line */\n  z-index: -99 \\9;\n  /* stylelint-disable-line */\n}\n',
          ''
        ]),
          (n.locals = { waterMark: 'watermark__waterMark-2yj37' });
      },
      kE3c: function(t, n, e) {
        t.exports = e('uC8H');
      },
      ...
      pNMO: function(t, n, e) {
        ...
        var r = e('I+eb'),
          ...
          it = function(t, n) {
            var e = (Q[t] = y(N[F]));
            return (
              _(e, { type: Y, tag: t, description: n }),
              u || (e.description = n),
              e
            );
          },
          ut =
            c && 'symbol' == typeof N.iterator
              ? function(t) {
          ...
          ft = function(t) {
            ...
            return (
              !(this === z && f(Q, n) && !f(Z, n)) &&
              (!(e || !f(this, n) || !f(Q, n) || (f(this, B) && this[B][n])) ||
                e)
            );
          },
          st = function(t, n) {
            ...
            if (e !== z || !f(Q, r) || f(Z, r)) {
              var o = X(e, r);
              return (
                !o || !f(Q, r) || (f(e, B) && e[B][r]) || (o.enumerable = !0), o
              );
            }
          },
          lt = function(t) {
        ...
        c ||
          (k(
            (N = function() {
              ...
              var t =
                ...
                e = function(t) {
                  this === z && e.call(Z, t),
                    f(this, B) && f(this[B], n) && (this[B][n] = !1),
                    ot(this, n, g(1, t));
                };
              return (
                u && rt && ot(z, n, { configurable: !0, set: e }), it(n, t)
              );
            })[F],
            'toString',
            function() {
          ...
          u &&
            ...
            i || k(z, 'propertyIsEnumerable', ft, { unsafe: !0 })),
          (P.f = function(t) {
            return it(I(t), t);
          })),
          r({ global: !0, wrap: !0, forced: !c, sham: !c }, { Symbol: N }),
          W(b(nt), function(t) {
            C(t);
          }),
          r(
      ...
      pevS: function(t, n, e) {
        ...
        t.exports = function(t, n) {
          var e,
            ...
            p = t.stat,
            d = t.proto,
            h = l ? y : p ? y[s] : (y[s] || {}).prototype,
            v = l ? x : x[s] || (x[s] = {}),
            g = v.prototype;
          for (o in n)
            (e = !w(l ? o : s + (p ? '.' : '#') + o, t.forced) && h && O(h, o)),
              (u = v[o]),
              e && (c = t.noTargetGet ? (f = b(h, o)) && f.value : h[o]),
              (i = e && c ? c : n[o]),
              (e && typeof u == typeof i) ||
                ((a =
                  t.bind && e
      ...
      tjUo: function(t, n, e) {
        ...
        var i = e('jP1q');
        e.d(n, 'NativeWaterMark', function() {
          return i['default'];
        }),
          (n['default'] = r['default']);
      },
