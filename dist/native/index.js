      ...
      jP1q: function(t, n, e) {
        ...
        function d(t) {
          if ((void 0 === t && (t = {}), t && 'object' == typeof t))
            return this instanceof d ? this.init(t) : new d(t);
        }
        (d.prototype = {
          constructor: d,
          ...
          init: function(t) {
            if (
              ((this.canvas.className = h.a.waterMark),
      ...
      pNMO: function(t, n, e) {
        ...
        c ||
          ...
          u &&
            ...
            i || M(z, 'propertyIsEnumerable', ft, { unsafe: !0 })),
          (R.f = function(t) {
            return it(I(t), t);
          })),
